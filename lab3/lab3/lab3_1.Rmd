...
#install.packages("package_name") is the command to install a new package
```
...
#character vectors must be in quotes in order to be recognized
```
...
Use lowercase always to avoid case errors!
```{r}
names(hbirds)
```
