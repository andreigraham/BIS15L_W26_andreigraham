...
\
```{r}
#ratio_of_hindlimb_to_body<- (anolis$hindlimb_length_mm/anolis$body_length_mm)
#anolis%>%
#ratio_of_tail_to_body<- (tail_length_mm/body_length_mm)
#ratio_of_hindlimb_to_body
#ratio_of_tail_to_body
...
#anolis%>%
 # (habitat)%>%
# summarise(mean_tl=mean(toepad_lamellae_count, na.rm=T),
 #          total=n())
