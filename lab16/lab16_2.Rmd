...
```{r}
#mv BIS15L_W26_andreigraham/lab16/data/blast_results/ls
#mv genome01_blastn.csv BIS15L_W26_andreigraham/lab16/data/blast_results/ls
```
...
```{r}
dna_file<- readDNAStringSet("e.coli_genbank.fasta")
```
...
```{r}
aa_file<- readAAStringSet("e.coli_coding_seq.fasta")
```
