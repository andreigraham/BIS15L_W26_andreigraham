...
ui <- dashboardPage(
  ...
  dashboardHeader(title = "Age and Height of Elephants based off of Sex"),
...
server <- function(input, output, session) {
  ...
  output$plot<- renderPlot({
      ...
      ggplot(elephants, 
      aes_string(x = "sex", y= input$y, fill = "sex"))+
    geom_boxplot()
...
```{r}
"~/elephants.csv"
#https://1drv.ms/x/c/13c6f461e442e340/IQCBQnRMWnB-Q6leVPDjV_HmATUqbKUjMQ5OXR4m8C9aVzw?e=kApOhb
```
