...
\
```{r}
read_csv("/Users/acekoii/Desktop/BIS15L_W26_andreigraham/lab7/data/elephants.csv")%>%
  clean_names()
...
\
```{r}
elephants<- read_csv("/Users/acekoii/Desktop/BIS15L_W26_andreigraham/lab7/data/elephants.csv")%>%
  clean_names()
```
\
\
